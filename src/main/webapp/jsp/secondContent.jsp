...
<head>
    ...
    <link href="../css/prestige.css" rel="stylesheet">
    ...
    <link href="../css/ityks.css" rel="stylesheet">
...
<div class="container-fluid">
        ...
        <tr>
            <td class="tbl">
                <div style="text-align: center;">
                    <p>楼主</p>
                    <a><img alt="" src="../image/ico_000.gif"/></a>
                </div>
            ...
            <td class="tbr">
                <div style="height: 65px;padding-left: 20px;padding-top: 1px;">
                    <h3><small><a style="color: #ifaeff">[${main.main_flag }]</a></small> <a
                            style="color: #ifaeff">${main.main_title }</a></h3>
                </div>
                ...
                <p class="text-right" style="padding-right: 90px;">
                    ...
                    <span><input type="text" style="width: 32px;"><a href="javascript:void(0)" style="color: #78BA00;"
                                                                     onclick="alert('跳楼')"><span
                            class="glyphicon glyphicon-screenshot" aria-hidden="true"></span>快速跳楼</a></span>
                </p>
                <div style="width:98%;height:1px;margin-bottom:10px;padding:0px;background-color:#D5D5D5;overflow:hidden;"></div>
                ...
                <div style="padding-right: 90px;">
                    <p class="text-right" style="color: yellow;"><a href="javascript:void(0)" onclick="alert('举报')"
                                                                    style="color: #f4b300;"><span
                            class="glyphicon glyphicon-warning-sign" aria-hidden="true"></span>举报</a></p>
                </div>
                            ...
                            <div style="padding-right: 90px;">
                                <p class="text-right" style="color: yellow;">
                                    <a href="javascript:void(0)"
                                       onclick="alert('回复${item.sec_id },${item.sec_sequence }')"
                                       style="color: #f4b300;"><span class="glyphicon glyphicon-fire"
                                                                     aria-hidden="true"></span>回复此楼</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="javascript:void(0)"
                                       onclick="alert('举报${item.sec_id },${item.sec_sequence }')"
                                       style="color: #f4b300;"><span class="glyphicon glyphicon-warning-sign"
                                                                     aria-hidden="true"></span>举报</a></p>
                            </div>
                        </td>
                    </tr>
                </c:forEach>
    ...
    <div class="row">
        <div class="col-xs-7">
            <span style="padding-left: 10px;"><button type="button" class="btn btn-primary"><span
                    class="glyphicon glyphicon-edit" aria-hidden="true"></span>发帖</button></span>
        </div>
        <div class="col-xs-5 text-nowrap">
            ${pageHtml }
    ...
    <form action="saveSencondContent" method="post" id="saveTiezi">
        <input name="mainId" type="hidden" value="${main.main_id }">
        <p class="text-right" style="padding-right: 90px;">
            <c:choose>
                <c:when test="${sessionScope.loginFlag}">
                    <button type="button" class="btn btn-primary btn-xs text-right" onclick="subForm()"><span
                            class="glyphicon glyphicon-edit" aria-hidden="true"></span>回复帖子
                    </button>
                </c:when>
                <c:otherwise>
                    <button type="button" class="btn btn-primary btn-xs text-right" onclick="goLogin()"><span
                            class="glyphicon glyphicon-edit" aria-hidden="true"></span>回复帖子
                    </button>
                </c:otherwise>
            </c:choose>
    ...
    <script type="text/javascript">
        ...
        editor.addListener('ready', function () {
            if (success) {
                ...
                editor.setContent('<br/><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="login.jsp" target="_parent" onclick="goLogin()">请登录</a>');
            }
        });
