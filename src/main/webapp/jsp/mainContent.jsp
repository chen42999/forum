		...
		<div class="col-xs-2 text-right">
			<c:choose>
				<c:when test="${mainType eq 'javase'}">
					<img alt="" src="../secondImage/language_length1.png">
				</c:when>
				<c:when test="${mainType eq 'android'}">
					<img alt="" src="../secondImage/language_length2.png">
				</c:when>
				<c:when test="${mainType eq 'c'}">
					<img alt="" src="../secondImage/language_length3.png">
				</c:when>
				<c:when test="${mainType eq 'javaweb'}">
					<img alt="" src="../secondImage/language_length5.png">
				</c:when>
				<c:when test="${mainType eq 'php'}">
					<img alt="" src="../secondImage/language_length6.png">
				</c:when>
				<c:when test="${mainType eq 'net'}">
					<img alt="" src="../secondImage/language_length7.png">
				</c:when>
				<c:when test="${mainType eq 'jsp'}">
					<img alt="" src="../secondImage/language_length8.png">
				</c:when>
				<c:when test="${mainType eq 'css'}">
					<img alt="" src="../secondImage/language_length9.png">
				</c:when>
				<c:when test="${mainType eq 'cplus'}">
					<img alt="" src="../secondImage/language_length10.png">
				</c:when>
				<c:when test="${mainType eq 'csharp'}">
					<img alt="" src="../secondImage/language_length11.png">
				</c:when>
				<c:when test="${mainType eq 'jquery'}">
					<img alt="" src="../secondImage/language_length12.png">
				</c:when>
				<c:when test="${mainType eq 'mysql'}">
					<img alt="" src="../secondImage/language_length14.png">
				</c:when>
				<c:when test="${mainType eq 'oracle'}">
					<img alt="" src="../secondImage/language_length15.png">
				</c:when>
				<c:when test="${mainType eq 'sqlserver'}">
					<img alt="" src="../secondImage/language_length16.png">
				</c:when>
				<c:otherwise>
					<img alt="" src="../secondImage/language_length4.png">
				</c:otherwise>
			</c:choose>
		</div>
  						...
  						<td>
  							...
  							<script type="text/javascript">
  								function setjinghua(mainId,flag){
  									$.ajax({
											url:"/jinghua?mainId="+mainId+"&flag="+flag,
											type:'GET',
