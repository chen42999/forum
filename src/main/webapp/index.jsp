...
<div class="container-fluid">
    <div class="bm bmw  flg cl con01" style="background-color: #ffffff;">
        ...
        <span class="o">
          <img id="category_8702_img" src="image/collapsed_no.gif" title="收起/展开" alt="收起/展开"
                        ...
                        <c:forEach items="${java}" var="forum" varStatus="vs">
                            ...
                            <td class="fl_g" width="32.9%">
                                <div class="fl_icn_g" style="width: 120px;">
                                    <a href="mainContent?mainType=${forum.dictKey }">
                                        <c:if test="${vs.index eq 0 }">
                                            <img src="image/language_java.png" alt="Java" align="left">
                                        </c:if>
                                        <c:if test="${vs.index eq 1 }">
                                            <img src="image/language_php.png" alt="PHP" align="left">
                                        </c:if>
                                        <c:if test="${vs.index eq 2 }">
                                            <img src="image/language_net.png" alt=".NET" align="left">
                                        </c:if>
                                        <c:if test="${vs.index eq 3 }">
                                            <img src="image/language_jsp.png" alt="JSP" align="left">
                                        </c:if>
                                    </a>
                                </div>
                                                ...
                                                <c:forEach items="${top5s }" var="top5" varStatus="vsa">
                                                    <c:if test="${not empty top5[forum.dictKey]}">
                                                        <c:forEach items="${top5[forum.dictKey] }" var="itm"
                                                                   varStatus="vsb">
                                                            <a href="secondContent?mainId=${itm.mainId}" target="_blank"
                                                               class="text-nowrap">${itm.mainTitle}</a>|
                                                        </c:forEach>
                                                    </c:if>
                                                </c:forEach>
                                            </c:when>
        ...
        <div id="category_8702" class="bm_c" style="">
            <table class="fl_tb">
                ...
                <tr class="fl_row">
                    <td class="fl_g" width="32.9%">
                        <div class="fl_icn_g" style="width: 120px;">
                            <a href="javascript:void(0)"><img src="image/language_mysql.png" alt="MySQL"
                                                              align="left"></a>
                        </div>
                        <dl style="margin-left: 120px;">
                            <dt>
                    ...
                    <td class="fl_g" width="32.9%">
                        <div class="fl_icn_g" style="width: 120px;">
                            <a href="javascript:void(0)"><img src="image/language_oracle.png" alt="Oracle" align="left"></a>
                        </div>
                        <dl style="margin-left: 120px;">
                            <dt>
                    ...
                    <td class="fl_g" width="32.9%">
                        <div class="fl_icn_g" style="width: 120px;">
                            <a href="javascript:void(0)"><img src="image/language_sqlsever.png" alt="SQLSever"
                                                              align="left"></a>
                        </div>
                        <dl style="margin-left: 120px;">
                            <dt>
                ...
                <tr class="fl_row">
                    <td class="fl_g" width="32.9%">
                        <div class="fl_icn_g" style="width: 120px;">
                            <a href="javascript:void(0)"><img src="image/language_other2.png" alt="Java"
                                                              align="left"></a>
                        </div>
                        <dl style="margin-left: 120px;">
                            <dt>
